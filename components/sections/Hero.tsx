            ...
            <div className="h-[100vh] overflow-hidden max-md:flex-col-reverse max-md:text-center max-md:gap-12 justify-around  flex w-full">
                <div className="w-1/2 max-md:w-full">
                    <div className="flex items-center gap-8 px-2  h-full w-full justify-center  flex-col">
                        <h1 className='font-serif  w-[400px] leading-[50px]  text-5xl'>Full service social media & digital marketing agency</h1>
                        <p className='w-[400px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem, praesentium!</p>
                        <div className="flex justify-start w-[400px] max-md:w-full">
                        <button className='text-center w-[200px] bg-none border max-md:w-full max-md:px-2 border-seconday-2 text-accent text-xl h-10 rounded-lg hover:border-none hover:bg-accent hover:text-white transition-all'> <Link href={'/services'}>See our Services </Link></button>
                        </div>
                    </div>
                </div>
